...
- If neither source is available, the API sets `uptime_available: false` and includes a localized `uptime_note` message indicating that uptime could not be determined.
