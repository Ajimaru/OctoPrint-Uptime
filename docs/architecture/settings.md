...
- `compact_toggle_interval_seconds` (integer, default `5`): Seconds between navbar switches in compact mode; non-integer values fall back to default (5), and integer values outside 5-60 are clamped to the nearest bound.
